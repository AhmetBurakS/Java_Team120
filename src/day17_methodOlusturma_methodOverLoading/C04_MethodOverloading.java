...
public class C04_MethodOverloading {
    ...
    /*
        ...
        Sonra arguement olarak verilen degerler ile, parametre olarak yazilan veriable'larin data turlerini karsilastirir
        ve uyumlu ise methodu calistirir
        arguementler ile parametreler uyumlu degilse CTE verir.
    ...
    public static void main(String[] args) {
       ...
       toplama(5.3,6); // double ve int'in toplami: 11.3
        ...
        toplama(3.4f,5); // double ve int'in toplam : 8.400000095367432
    ...
    public static void toplama(double b, int a){  // toplama double int
        System.out.println("double ve int'in toplam : " + (a+b));
    }

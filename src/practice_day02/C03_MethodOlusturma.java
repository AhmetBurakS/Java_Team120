...
public class C03_MethodOlusturma {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Lutfen isminizi giriniz"); // tek isim giriyoruz
        String isim = scanner.next();

        System.out.println("Lutfen soyisminizi giriniz");  // tek kelime
        String soyisim = scanner.next();

        System.out.println(isimDuzenle(isim, soyisim));  //istersek direkt dondurdugu sonucu yazdirabilir
